...
|---|---|---|---|---|---|---|
| [MASTER-DATA-INACTIVE-VISIBILITY-DISCOVERY-01](MASTER-DATA-INACTIVE-VISIBILITY-DISCOVERY-01.md) | Cadastro inativo (Item, Fornecedor, Produto): onde some do que ainda existe e onde vaza para operação nova | `EM_ANALISE` | 2026-09-17 | D1–D3 decididas pelo PO: inativo com posição (saldo, reservado ou em compra) aparece no Estoque marcado; sem posição só com "Incluir inativos sem saldo", CSV igual à tela; Contagem rápida, saída e perda permitidas, entrada manual recusada (sobra entra pela contagem). D4–D9 recomendadas: receber OC confirmada com marca, OP nova recusa componente inativo, Produto inativo sem operação comercial nova, Produto × PA sem cascata, relação com item/fornecedor inativo sem homologar/preferencial/oferta, R-18 em "Todos". Entregue só no chat e persistido na Fatia 1 | D4–D9, uma fatia por vez | Parcial: Fatia 1 por INVENTORY-INACTIVE-ITEM-VISIBILITY-01 (2026-09-17, na `main`, fora de PROD, §107). Próximas: PRODUCT-INACTIVE-COMMERCIAL-GATE-01, SUPPLIER-ITEM-INACTIVE-GATE-01, PRODUCTION-INACTIVE-COMPONENT-GATE-01, opcional INACTIVE-MARKERS-REPORTS-01 |
