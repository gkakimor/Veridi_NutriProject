...
|---|---|---|---|---|---|---|
| [ITEM-SUPPLIER-UX-DISCOVERY-01](ITEM-SUPPLIER-UX-DISCOVERY-01.md) | Item × Fornecedor administrável no cadastro do Item e do Fornecedor | `EM_ANALISE` | 2026-09-16 | D3 decidida: Compras cria a relação, os dados comerciais e a primeira oferta, e administra o preferencial quando elegível, mas a relação nasce `PENDING`; homologar e bloquear, também na criação, são de Qualidade e Administrador (403 com o motivo, nada gravado); voltar para pendente com Compras, Qualidade e Administrador; o Administrador mantém a criação com situação explícita. Recomendado, sem decisão: Fatia 1 no modal do Item, Fatia 2 no Fornecedor, tela geral como está. Entregue só no chat e persistido depois, a partir do resumo da sessão | Confirmar o escopo das Fatias no handoff de ITEM-SUPPLIER-UX-01 e reapresentar as decisões do relatório original que não foram preservadas, se valerem; nenhuma bloqueia | Parcial: D3 por ITEM-SUPPLIER-QUALIFICATION-PERMISSION-01, entregue em 2026-09-16 (na `main`, fora de PROD). Próxima: ITEM-SUPPLIER-UX-01 (Fatia 1) |
