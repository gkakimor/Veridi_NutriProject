...
| Preço documental e tarifa não migram junto do custo por semelhança de nome | UNIT_PRICE e RATE são categorias distintas de UNIT_COST | `scripts/numeric-precision-matrix.test.ts` |
