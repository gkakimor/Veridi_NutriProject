...
[`RELEASES.md`](RELEASES.md)). A suíte web completa em `5b7c1a3` tem 2 falhas conhecidas, que já existiam em
`3159180` (WEB-SUITE-PREEXISTING-FAILURES-01, seção A). Reconciliado com o estado real em 2026-09-15
...
| 2b | P1 | **FORMULATION-TEMPLATE-TECHNICAL-SHEET-PDF-01** — Ficha Técnica do Modelo de Formulação em PDF real | **NÃO INICIADA · PÓS-PUBLICAÇÃO** — próxima atividade depois da publicação de 2026-09-16, que saiu sem ela por decisão do PO · capability pequena, nada implementado · a ficha do Produto (FORMULATION-TECHNICAL-SHEET-PDF-01) já tem read model neutro para receber um adaptador do Modelo | Adaptador da versão do Modelo sobre `apps/web/src/pdf/documents/technical-sheet-model.ts` e a ação na página do Modelo | FORMULATION-TEMPLATE-WORKBENCH-01 fechado |
...
(FORMULATION-TEMPLATE-TECHNICAL-SHEET-PDF-01, posição 2b da fila) e a tabela Forma × Apresentação, logo abaixo.
