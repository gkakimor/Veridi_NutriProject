...
| **SUPPLIER-ITEM-INACTIVE-GATE-01** · **PRODUCTION-INACTIVE-COMPONENT-GATE-01** · INACTIVE-MARKERS-REPORTS-01 (opcional) — fatias 3–4 do cadastro inativo | Registradas em 2026-09-17 com o discovery; INVENTORY-INACTIVE-ITEM-VISIBILITY-01 fechou a Fatia 1 e PRODUCT-INACTIVE-COMMERCIAL-GATE-01 a Fatia 2. D4, D5, D8 e D9 têm recomendação e esperam o handoff do PO, uma fatia por vez | [discovery](discovery/MASTER-DATA-INACTIVE-VISIBILITY-DISCOVERY-01.md) |
