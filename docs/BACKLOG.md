...
| **ITEM-SUPPLIER-UX-01** — Item × Fornecedor administrável no modal do Item (Fatia 1) e no Fornecedor (Fatia 2) | Discovery `EM_ANALISE`; a D3, que bloqueava a Fatia 1, fechou em 2026-09-16 (ITEM-SUPPLIER-QUALIFICATION-PERMISSION-01). Espera o handoff do PO | G |
...
### ITEM-SUPPLIER-UX-01 — Item × Fornecedor administrável no Item e no Fornecedor — sem posição

Proposta do [ITEM-SUPPLIER-UX-DISCOVERY-01](discovery/ITEM-SUPPLIER-UX-DISCOVERY-01.md) (2026-09-16, `EM_ANALISE`),
**sem posição e sem implementação**. Hoje a seção Fornecedores do modal do Item e Itens fornecidos do Fornecedor só
listam; criar a relação, homologar e registrar preço acontecem em Compras › Item × Fornecedor. Recomendado: Fatia 1 no
modal do Item, reutilizando `SupplierItemFormModal` e `SupplierItemDetailModal`; Fatia 2 no Fornecedor; tela geral como
está. Sem migration. A D3, que bloqueava a Fatia 1 (Compras criava a relação já homologada), fechou em 2026-09-16 com
ITEM-SUPPLIER-QUALIFICATION-PERMISSION-01 (§101). Duas E2E passam pela "Nova relação" da tela geral.
