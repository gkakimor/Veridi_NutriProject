...
export const SEVERITY_BY_CODE: Record<string, FindingSeverity> = {
  ...
  // ── Cliente, Item e Produto vindos do pacote revisado ─────
  // Mesma regra do Fornecedor: o dado passou por gente, então valor inválido
  // é engano na revisão e se corrige no Excel, não no importador.
  CUSTOMER_REVIEW_WITHOUT_NAME: "BLOCKING",
  CUSTOMER_REVIEW_WITHOUT_CODE: "BLOCKING",
  CUSTOMER_REVIEW_CNPJ_INVALID: "BLOCKING",
  CUSTOMER_REVIEW_ZIP_INVALID: "BLOCKING",
  CUSTOMER_REVIEW_STATE_INVALID: "BLOCKING",
  CUSTOMER_REVIEW_TAX_PROFILE_INVALID: "BLOCKING",
  CUSTOMER_REVIEW_CODE_COLLISION: "BLOCKING",
  CUSTOMER_REVIEW_NOT_IMPORTED: "INFO",

  ITEM_REVIEW_WITHOUT_NAME: "BLOCKING",
  ITEM_REVIEW_WITHOUT_CODE: "BLOCKING",
  ITEM_REVIEW_TYPE_INVALID: "BLOCKING",
  ITEM_REVIEW_UOM_INVALID: "BLOCKING",
  ITEM_REVIEW_FAMILY_INVALID: "BLOCKING",
  ITEM_REVIEW_PACKAGING_SUBTYPE_INVALID: "BLOCKING",
  ITEM_REVIEW_PACKAGING_SUBTYPE_ON_RAW_MATERIAL: "BLOCKING",
  ITEM_REVIEW_PURITY_INVALID: "BLOCKING",
  ...
  PRODUCT_REVIEW_WITHOUT_EXTERNAL_CODE: "BLOCKING",
  PRODUCT_REVIEW_FINISHED_ITEM_MISMATCH: "BLOCKING",
  PRODUCT_REVIEW_EXTERNAL_CODE_CHANGED: "BLOCKING",
  PRODUCT_REVIEW_UOM_INVALID: "BLOCKING",
  PRODUCT_REVIEW_ENUM_INVALID: "BLOCKING",
  PRODUCT_REVIEW_NUMBER_INVALID: "BLOCKING",
  PRODUCT_REVIEW_DOSE_WITHOUT_UOM: "BLOCKING",
  PRODUCT_REVIEW_CODE_COLLISION: "BLOCKING",
  PRODUCT_REVIEW_FINISHED_ITEM_COLLISION: "BLOCKING",
  PRODUCT_REVIEW_NOT_IMPORTED: "INFO",

  // Relação elegível que aponta para registro que a Veridi tirou da carga, ou
  // para chave que não existe no workbook. Trocar por "o mais parecido" seria
  // inventar — e é exatamente o erro que a migração não pode cometer.
  PRODUCT_REVIEW_CUSTOMER_NOT_IMPORTED: "BLOCKING",
  PRODUCT_REVIEW_CUSTOMER_KEY_UNKNOWN: "BLOCKING",
  FORMULATION_ITEM_NOT_IMPORTED: "BLOCKING",
  PROJECT_CUSTOMER_NOT_IMPORTED: "BLOCKING",
  SUPPLIER_ITEM_ITEM_NOT_IMPORTED: "BLOCKING",
  SUPPLIER_ITEM_ITEM_KEY_UNKNOWN: "BLOCKING",
  ...
  // Rastreabilidade comercial (capacidade 47): descreve, nunca corrige.
  PROJECT_WITHOUT_TECHNICAL_PRODUCT: "INFO",
  QUOTE_MANUAL_PRICE_SOURCE: "INFO",
  QUOTE_PRICING_COST_PARTIAL: "REVIEW",
  LEGACY_QUOTE_WITHOUT_PRICING_PROVENANCE: "INFO",
