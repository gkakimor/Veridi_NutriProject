...
const r13 = defineCsvExport({
  ...
  columns: [
    ...
    { header: "Qtd. pedida", value: (row: FulfillmentRowDTO) => csvDecimal(row.orderedQuantity) },
...
const r17 = defineCsvExport({
  ...
  columns: [
    ...
    { header: "Qtd. pedida", value: (row: OrderDeliveredBilledRowDTO) => csvDecimal(row.orderedQuantity) },
