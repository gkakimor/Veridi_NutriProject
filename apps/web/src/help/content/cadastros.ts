...
export const cadastrosTopics = {
  "item.comoFunciona": {
    ...
    flows: [
      {
        ...
        steps: [
          ...
          },
          {
            label: "Dados do tipo",
            detail:
              "O formulário mostra só o que é do tipo escolhido. Matéria-prima: classificação industrial — fonte, nutriente declarado, família e pureza padrão, tudo opcional, o ponto de partida da formulação. Material de embalagem: subtipo e consumido na produção; no subtipo Rótulo, o arquivo da arte já pode ser escolhido aqui.",
          },
          {
    ...
    notes: [
      ...
      "Arquivo do rótulo escolhido na criação é opcional e só é enviado depois que o item existe, como V1. Trocar o tipo ou o subtipo descarta o arquivo escolhido. Se o item for criado e o envio falhar, a tela avisa que o item já existe e abre o arquivo do rótulo dele para tentar de novo — o item nunca é criado outra vez.",
